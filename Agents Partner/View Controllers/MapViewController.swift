...
class MapViewController: UIViewController {
  ...
  @IBAction func unwindFromAddNewEntry(segue: UIStoryboardSegue) {
    ...
    let addedSpecimenCoordinate = CLLocationCoordinate2D(
        latitude: addedSpecimen.latitude, longitude: addedSpecimen.longitude
    )
    ...
    let annotation = SpecimenAnnotation(
        coordinate: addedSpecimenCoordinate, title: addedSpecimen.name, subtitle: addedSpecimen.category.name, specimen: addedSpecimen)
    ...
    func populateMap() {
        ...
        for specimen in specimens {
            let coord = CLLocationCoordinate2D(
                latitude: specimen.latitude, longitude: specimen.longitude);
